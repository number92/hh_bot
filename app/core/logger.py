...
def get_logger(name=__name__, base_dir=config.BASE_DIR, level=logging.INFO, handler: str = "file") -> logging.Logger:
    ...
    def _get_handler(handler: str):
        ...
        return logging.FileHandler(log_file) if handler == "file" else logging.StreamHandler()
